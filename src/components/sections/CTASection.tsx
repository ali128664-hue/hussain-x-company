    ...
    <section className="py-28 relative px-6 overflow-hidden">
      ...
      <AnimatedSection className="max-w-5xl mx-auto relative rounded-3xl overflow-hidden">
        ...
        <div className="relative bg-gradient-to-br from-[#1A0E08] via-[#2B1A12] to-[#0A0A0A] border border-[#3A2920] p-12 md:p-16 text-center shadow-2xl">
          <BorderBeam size={350} duration={10} colorFrom="#F5620F" colorTo="#FF8A50" />

          {/* Glow blobs */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-40 bg-[#F5620F]/15 blur-[80px] pointer-events-none rounded-full" />
          <div className="absolute bottom-0 right-1/4 w-48 h-32 bg-[#F5620F]/8 blur-[60px] pointer-events-none rounded-full" />
          ...
          <div className="relative z-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#F5620F]/30 bg-[#F5620F]/10 text-[#F5620F] text-xs font-mono font-semibold uppercase tracking-widest mb-8"
            >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-[1.1] tracking-tight">
              Ready to Build Your{' '}
              <span className="text-[#F5620F]">Digital Solution?</span>
            </h2>
