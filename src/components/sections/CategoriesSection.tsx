...
const categories = [
  {
    ...
    description: 'Custom Software • Web Apps • Mobile Apps • SaaS',
    services: ['Custom Software', 'Web Apps', 'Mobile Apps', 'SaaS'],
  ...
  },
  {
    ...
    description: 'Websites • Shopify • WordPress • E-commerce',
    services: ['Websites', 'Shopify', 'WordPress', 'E-commerce'],
  ...
  },
  {
    ...
    description: 'UI/UX • Branding • Video • Creative Design',
    services: ['UI/UX', 'Branding', 'Video', 'Creative Design'],
  ...
  },
  {
    ...
    description: 'SEO • PPC • Social Media • Content',
  ...
  },
  {
    ...
    description: 'Cloud • APIs • Automation • Security',
    services: ['Cloud', 'APIs', 'Automation', 'Security'],
    ...
    <section className="py-24 relative z-10">
      <div className="container mx-auto px-6 max-w-6xl">
        <AnimatedSection>
          <SectionHeading
            label="What We Do"
            title="Complete Digital Solutions Ecosystem"
            align="center"
            className="mb-16"
          />
        </AnimatedSection>
