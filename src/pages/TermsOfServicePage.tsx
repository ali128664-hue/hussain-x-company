...
const sections = [
  {
    ...
    content: [
      'By accessing or using the website and services of Hussain X Solutions ("Company", "we", "us", or "our"), you agree to be bound by these Terms of Service.',
  ...
  },
  {
    ...
    content: [
      'Hussain X Solutions offers a range of digital services including but not limited to:',
  ...
  },
  {
    ...
    content: [
      'Upon full payment of all invoices, Hussain X Solutions transfers ownership of the final deliverables to the client.',
      ...
      'All source code, designs, and proprietary tools developed by Hussain X Solutions prior to or independent of your project remain our intellectual property.',
  ...
  },
  {
    ...
    content: [
      'Hussain X Solutions shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our services.',
        ...
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          <AnimatedSection>
            ...
            <p className="text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Please read these Terms of Service carefully before using our services. By engaging with Hussain X Solutions, you agree to be bound by these terms.
            </p>
          </AnimatedSection>
        </div>
      </section>
